<?php
        ...
        if($_POST){
            ...
            $q = mysqli_query($connection,"insert into tbl_product (pro_name,pro_price,pro_details,pro_photo)values('{$pname}','{$pprice}','{$pdetails}','{$filename}')");
                                ...
                                <div class="form-body">
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data"> 
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-9"> 
                                                <input type="text" class="form-control" id="inputEmail3" name="pname" required placeholder="Enter Product Name"> 
                                            </div> 
                                        </div> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-9"> 
                                                <input type="number" class="form-control" id="inputEmail3" name="pprice" required placeholder="Enter Price"> 
                                            </div> 
                                        </div> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-sm-9"> 
                                                <input type="file" class="form-control" name="file123"> 
                                            </div> 
                                        </div> 
                                        ...
                                        <div class="col-sm-offset-2"> 
                                            ...
                                            <button type="button" onclick="window.location='dis-product.php';" class="btn btn-info">View</button> 
                                        </div>
                                    </form> 
                                </div>
                            </div>
